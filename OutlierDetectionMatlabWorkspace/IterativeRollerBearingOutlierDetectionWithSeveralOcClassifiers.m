...
subplot(4,1,4), 
   ...
   for i=0:numberOfIterations
       ...
       % K-Centers
       w = kcenter_dd(targetData, fractionOfRejectedTrainingData,5);
       e = dd_error(testData,w);
       kcenterRejectedNormals= kcenterRejectedNormals+e(1);
       kcenterAcceptedOutliers= kcenterAcceptedOutliers+e(2);
       % NN-d
       w = nndd(targetData, fractionOfRejectedTrainingData);
       e = dd_error(testData,w);
       ...
       % SOM-dd
       w = som_dd(targetData, fractionOfRejectedTrainingData);
       e = dd_error(testData,w);
   ...
   nddAcceptedOutliers= nddRejectedOutliers/numberOfIterations
